...
class SACBCAgent(nn.Module):
    ...
    def update_actor(
        ...
        mean_actions = actor_dists.base_dist.base_dist.mode.tanh()
        mses = nn.functional.mse_loss(mean_actions, actions)
    ...
    def update_target_critic(self) -> None:
        ...
        for param, target_param in zip(self.critic.parameters(), self.target_critic.parameters()):
            new_val = self.target_update_rate * param.data + (1 - self.target_update_rate) * target_param.data
